...
default_args = {
 ...
 'prompt': 'Do any of the values of the inbound or outbound packets abnormal', # Enter your prompt here
 'context' : 'These data are anomaly probabilities of suspected data traffic \
Ahigh probability of over 0.80 is liekly suspicious \
', # what is this data about? Provide context to PrivateGPT
