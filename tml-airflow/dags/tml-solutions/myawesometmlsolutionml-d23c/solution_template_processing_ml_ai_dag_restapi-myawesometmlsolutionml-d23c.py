...
step1 = importlib.import_module("tml-solutions.myawesometmlsolutionml-d23c.tml_system_step_1_getparams_dag-myawesometmlsolutionml-d23c")
step2 = importlib.import_module("tml-solutions.myawesometmlsolutionml-d23c.tml_system_step_2_kafka_createtopic_dag-myawesometmlsolutionml-d23c")
step3 = importlib.import_module("tml-solutions.myawesometmlsolutionml-d23c.tml_read_RESTAPI_step_3_kafka_producetotopic_dag-myawesometmlsolutionml-d23c")
step4 = importlib.import_module("tml-solutions.myawesometmlsolutionml-d23c.tml_system_step_4_kafka_preprocess_dag-myawesometmlsolutionml-d23c")
step5 = importlib.import_module("tml-solutions.myawesometmlsolutionml-d23c.tml_system_step_5_kafka_machine_learning_dag-myawesometmlsolutionml-d23c")
step6 = importlib.import_module("tml-solutions.myawesometmlsolutionml-d23c.tml_system_step_6_kafka_predictions_dag-myawesometmlsolutionml-d23c")
step7 = importlib.import_module("tml-solutions.myawesometmlsolutionml-d23c.tml_system_step_7_kafka_visualization_dag-myawesometmlsolutionml-d23c")
step8 = importlib.import_module("tml-solutions.myawesometmlsolutionml-d23c.tml_system_step_8_deploy_solution_to_docker_dag-myawesometmlsolutionml-d23c")
step9 = importlib.import_module("tml-solutions.myawesometmlsolutionml-d23c.tml_system_step_9_privategpt_qdrant_dag-myawesometmlsolutionml-d23c")
step10 = importlib.import_module("tml-solutions.myawesometmlsolutionml-d23c.tml_system_step_10_documentation_dag-myawesometmlsolutionml-d23c")


with DAG(
    dag_id="solution_preprocessing_ml_ai_restapi_dag-myawesometmlsolutionml-d23c",
