...
step3 = importlib.import_module("tml-solutions.myawesometmlsolutionml-d23c.tml_read_LOCALFILE_step_3_kafka_producetotopic_dag-myawesometmlsolutionml-d23c")
...
with DAG(
    dag_id="solution_preprocessing_ml_ai_dag-myawesometmlsolutionml-d23c",
