...
@dag(dag_id="tml_system_step_7_kafka_visualization_dag_myawesometmlsolution-d23c", default_args=default_args, tags=["tml_system_step_7_kafka_visualization_dag_myawesometmlsolution-d23c"], schedule=None,catchup=False)
def startstreaming():    
  def empty():
      pass
dag = startstreaming()
