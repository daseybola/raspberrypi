...
default_args = {
 ...
 'solutionname': 'myawesometmlsolution-d23c',   # <<< *** DO NOT MODIFY - THIS WILL BE AUTOMATICALLY UPDATED
...
@dag(dag_id="tml_system_step_1_getparams_dag_myawesometmlsolution-d23c", default_args=default_args, tags=["tml_system_step_1_getparams_dag_myawesometmlsolution-d23c"], schedule=None, catchup=False)
def tmlparams():
    # Define tasks
    def empty():
        pass
