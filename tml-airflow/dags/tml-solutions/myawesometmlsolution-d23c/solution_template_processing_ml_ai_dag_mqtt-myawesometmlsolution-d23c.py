...
step3 = importlib.import_module("tml-solutions.myawesometmlsolution-d23c.tml_read_MQTT_step_3_kafka_producetotopic_dag-myawesometmlsolution-d23c")
...
with DAG(
    dag_id="solution_preprocessing_ml_ai_mqtt_dag-myawesometmlsolution-d23c",
